...
La [fiche de littérature](repo:docs/literature/frazzini_pedersen_2014_bab.md) distingue cette explication des critiques portant sur la construction du facteur.
...
Sur les titres, de janvier 2001 à juin 2026, le Sharpe passe de {{s005_raw}} sans réduction du bêta à {{s005_shrink}} avec la réduction de référence.
...
La [discussion sur l'estimation du risque](repo:docs/literature/ledoit_wolf_2004.md) explique pourquoi stabiliser une estimation exige une comparaison adaptée.

## Vérifier le résultat

Les [mesures enregistrées](repo:studies/005_betting_against_beta/results/metrics.json) donnent les nombres et leurs fenêtres.
L'[annexe technique](repo:studies/005_betting_against_beta/ANNEXE_TECHNIQUE.md) conserve les tableaux, les hypothèses, les limites et les commandes de calcul.
Le [script de l'étude](repo:studies/005_betting_against_beta/run.py) relie ces choix aux fonctions du laboratoire.
