...
La [fiche de l'article](repo:docs/literature/lou_polk_skouras_2019.md) présente les stratégies et les limites de la transposition.
...
| Nuit | {{s018_night}} % |
| Séance | {{s018_day}} % |
| Résidu de la décomposition retenue | {{s018_residual}} % |
| Total excédentaire | {{s018_total}} % |

Ces nombres viennent de la section `strategy` des [résultats enregistrés](repo:studies/018_nuit_contre_journee/results/metrics.json).
...
![Décomposer le résultat de nuit et de séance](repo:docs/guide/figures/nuit_journee.png)
...
L'[annexe technique](repo:studies/018_nuit_contre_journee/ANNEXE_TECHNIQUE.md) conserve les cinq fonds et les contrôles d'identité.
La [comparaison avec LEAN](repo:lean/README.md) examine séparément ce que change un autre calendrier d'exécution.
