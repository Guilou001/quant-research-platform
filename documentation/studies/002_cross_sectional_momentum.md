...
La [fiche de l'article](repo:docs/literature/jegadeesh_titman_1993.md) précise les périodes de formation, de détention et le délai entre les deux.
...
L'écart gagnant moins perdant passe de {{s002_before}} % par mois sur la fenêtre originale à {{s002_after}} % sur 1994-2026, avant frais.
...
Cet exemple réel justifie la prudence du [chapitre sur les données](repo:docs/guide/02_donnees.md).
...
Les [mesures enregistrées](repo:studies/002_cross_sectional_momentum/results/metrics.json) donnent les nombres et leurs fenêtres.
L'[annexe technique](repo:studies/002_cross_sectional_momentum/ANNEXE_TECHNIQUE.md) conserve les tableaux, les hypothèses, les limites et les commandes de calcul.
Le [script de l'étude](repo:studies/002_cross_sectional_momentum/run.py) relie ces choix aux fonctions du laboratoire.
