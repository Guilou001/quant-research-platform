...
La [spécification](repo:docs/specs/005-cryptomonnaies-coin-metrics.md) décrit les données communautaires Coin Metrics.
...
Le momentum présente un Sharpe net de {{s019_sharpe}} sur 213 semaines après avril 2022, jusqu'au 24 mai 2026.
Le coût de base vaut 50 points de base par unité négociée.
La rotation moyenne publiée pour l'ensemble de l'historique vaut {{s019_turn}} fois le capital par semaine.
...
Les [mesures enregistrées](repo:studies/019_facteurs_crypto/results/metrics.json) donnent les nombres et leurs fenêtres.
L'[annexe technique](repo:studies/019_facteurs_crypto/ANNEXE_TECHNIQUE.md) conserve les tableaux, les hypothèses, les limites et les commandes de calcul.
Le [script de l'étude](repo:studies/019_facteurs_crypto/run.py) relie ces choix aux fonctions du laboratoire.
