...
La comparaison reprend les références de l'[étude 009](repo:docs/etudes/009_multi_strategy.md).
...
Le Sharpe de la référence en parité de risque vaut {{s012_after}} sur janvier 2020 à juin 2026.
...
Le [chapitre sur la diversification](repo:docs/guide/07_portefeuille.md) explique pourquoi réduire le risque et améliorer le rendement moyen sont deux objectifs distincts.

## Vérifier le résultat

Les [mesures enregistrées](repo:studies/012_multi_strategy_net/results/metrics.json) donnent les nombres et leurs fenêtres.
L'[annexe technique](repo:studies/012_multi_strategy_net/ANNEXE_TECHNIQUE.md) conserve les tableaux, les hypothèses, les limites et les commandes de calcul.
Le [script de l'étude](repo:studies/012_multi_strategy_net/run.py) relie ces choix aux fonctions du laboratoire.
