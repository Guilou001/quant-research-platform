...
![Ce que l'oubli de deux entreprises change](repo:docs/guide/figures/survie_exemple.png)
...
L'[étude 011](repo:docs/etudes/011_cross_sectional_ml.md) dispose d'un historique court et de 27 caractéristiques.
...
La [fiche Gu, Kelly et Xiu](repo:docs/literature/gu_kelly_xiu_2020.md) explique le protocole de référence et ses différences avec nos données.
...
|---|---:|---:|---:|
| Régression pénalisée | {{s013_linear_r2}} % | {{s013_linear_rank}} | {{s013_linear_sharpe}} |
| Arbres amplifiés | {{s013_tree_r2}} % | {{s013_tree_rank}} | {{s013_tree_sharpe}} |
| Forêt aléatoire | {{s013_forest_r2}} % | {{s013_forest_rank}} | {{s013_forest_sharpe}} |
...
Les [erreurs de prévision](repo:studies/013_cross_sectional_ml_long/results/tables/evaluation.csv)
et les [portefeuilles enregistrés](repo:studies/013_cross_sectional_ml_long/results/tables/portfolios.csv) sont les sources du tableau.
...
Les résultats détaillés et les écarts de définition restent dans l'[annexe technique](repo:studies/013_cross_sectional_ml_long/ANNEXE_TECHNIQUE.md).
Le [chapitre sur les dates](repo:docs/guide/02_donnees.md) explique pourquoi dater les informations et reconstruire l'univers sont deux contrôles différents.
