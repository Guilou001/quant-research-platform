...
La [fiche de littérature](repo:docs/literature/garleanu_pedersen_2013.md) explique la différence.
...
|---|---:|---:|
| Rejoindre la moitié du chemin | {{s017_turn_partial}} | {{s017_partial}} |
| Rejoindre toute la cible | {{s017_turn_full}} | {{s017_full}} |
...
Cette distinction est le sujet du [chapitre sur le calendrier](repo:docs/guide/03_calendrier.md).

## Vérifier le résultat

Les [mesures enregistrées](repo:studies/017_viser_devant_la_cible/results/metrics.json) donnent les nombres et leurs fenêtres.
L'[annexe technique](repo:studies/017_viser_devant_la_cible/ANNEXE_TECHNIQUE.md) conserve les tableaux, les hypothèses, les limites et les commandes de calcul.
Le [script de l'étude](repo:studies/017_viser_devant_la_cible/run.py) relie ces choix aux fonctions du laboratoire.
