...
Il vaut `1 - 8 / 29`, soit {{example_r2}} %. Ce pourcentage ne compte pas les prévisions correctes.
...
![Les trois actions prévues et observées](repo:docs/guide/figures/prevision_classement.png)
...
La [fiche de littérature](repo:docs/literature/gu_kelly_xiu_2020.md) détaille les spécifications et les versions consultées.
...
|---|---:|---:|---:|
| Régression pénalisée | {{s011_linear_r2}} % | {{s011_linear_rank}} | {{s011_linear_sharpe}} |
| Arbres amplifiés | {{s011_tree_r2}} % | {{s011_tree_rank}} | {{s011_tree_sharpe}} |
| Forêt aléatoire | {{s011_forest_r2}} % | {{s011_forest_rank}} | {{s011_forest_sharpe}} |
...
Les nombres proviennent des [erreurs et classements](repo:studies/011_cross_sectional_ml/results/tables/evaluation.csv)
et des [portefeuilles](repo:studies/011_cross_sectional_ml/results/tables/portfolios.csv).
...
L'[annexe technique](repo:studies/011_cross_sectional_ml/ANNEXE_TECHNIQUE.md) conserve les six modèles et leurs fenêtres.
L'[étude 013](repo:docs/etudes/013_cross_sectional_ml_long.md) prolonge l'historique sans résoudre la sélection des entreprises.
