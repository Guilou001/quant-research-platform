...
Le calcul donne « un moins 0,95 à la puissance 100 », soit {{example_false_positive}} %.
...
![Le gagnant de la sélection confronté à une seconde période indépendante](repo:docs/guide/figures/selection_hasard.png)

Sa moyenne mensuelle vaut {{example_search}} % pendant la sélection.
Sur 360 nouveaux mois indépendants, elle vaut {{example_test}} %.
...
![Distribution de moyennes obtenues par blocs sur douze mois fictifs](repo:docs/guide/figures/bootstrap.png)
...
Les fiches [DSR](repo:docs/literature/bailey_lopez_de_prado_2014_dsr.md), [PBO](repo:docs/literature/bailey_et_al_2016_pbo.md) et [tests multiples](repo:docs/literature/harvey_liu_zhu_2016.md) détaillent leurs hypothèses.
L'[étude 016](repo:docs/etudes/016_publication_decay_212.md) montre pourquoi une différence historique et une cause établie restent deux conclusions distinctes.
