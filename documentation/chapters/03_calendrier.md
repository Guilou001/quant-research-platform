...
![Trois périodes séparées dans un calendrier fictif](repo:docs/guide/figures/calendrier.png)
...
L'[étude 017](repo:docs/etudes/017_viser_devant_la_cible.md) choisit une vitesse de rééquilibrage avant la période finale.
...
Les [découpages de validation](repo:docs/validation/index.md) décrivent les procédures disponibles.
L'[étude 011](repo:docs/etudes/011_cross_sectional_ml.md) montre leur emploi pour prévoir les rendements des actions.

Avant de comparer deux résultats, vérifiez qu'ils portent sur les mêmes mois.
Le [chapitre suivant](repo:docs/guide/04_hasard.md) explique pourquoi leur différence demande encore une mesure d'incertitude.
