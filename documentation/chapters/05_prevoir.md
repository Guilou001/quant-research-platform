...
![Prévisions proches des niveaux observés, mais préférences inversées](repo:docs/guide/figures/prevision_classement.png)

L'[étude 011](repo:docs/etudes/011_cross_sectional_ml.md) déroule le calcul à la main.
Son R² fictif vaut {{example_r2}} %.
...
La [fiche de l'article](repo:docs/literature/gu_kelly_xiu_2020.md) sépare la méthode originale et notre adaptation.

L'[étude 013](repo:docs/etudes/013_cross_sectional_ml_long.md) étend la période étudiée.
