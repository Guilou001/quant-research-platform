...
Essayer de nombreuses stratégies sans signal peut produire un meilleur résultat apparent par hasard. Son amplitude dépend de la durée des données, de leur dépendance et du nombre d'essais réellement distincts. Un Sharpe supérieur à 2 n'est donc pas une conséquence automatique de mille essais. Le protocole conserve ces informations pour évaluer l'incertitude. Il faut des données qui savent
