...
|---|---:|
| Écart mensuel maximal entre les deux moteurs, après retrait du financement | 4,7e-6 |
...
| Coût d'une exécution à l'ouverture réelle du lendemain, le prix de la convention du laboratoire | 25 points de base par an, Sharpe 0,377 à 0,363 |
| Coût d'un retard d'une séance entière sur les ordres | 71 points de base par an, Sharpe 0,377 à 0,336 |

Statut mesuré le 2026-09-03, relancé le même jour après l'audit sur des entrées fraîches. Le rapport complet, avec les conventions de
...
décision du laboratoire désignent donc le même prix, ce qui vérifie
l'arithmétique. Un second jeu porte l'ouverture réelle, ce qui mesure le prix
de cette convention. Le rendement total
