...
L'[étude 018](../etudes/018_nuit_contre_journee.md) explique pourquoi on ne peut pas appliquer ce calcul sans vérifier les positions réellement négociées.
L'[étude 007](../etudes/007_statistical_arbitrage.md) mesure le seuil de coût qui annule son propre rendement brut.
...
L'[étude 010](../etudes/010_capacity.md) examine cette question sur deux stratégies dont les positions et les volumes sont disponibles.
...
Le [moteur analytique](../analytics/index.md) décrit les conventions, et les annexes donnent les coefficients propres aux études.

L'[étude 017](../etudes/017_viser_devant_la_cible.md) pose ensuite une question pratique.
