...
![Capital final avec et sans les deux entreprises disparues dans un exemple fictif](figures/survie_exemple.png)
...
L'[étude 013](../etudes/013_cross_sectional_ml_long.md) montre pourquoi un historique plus long ne répare pas une sélection incomplète.
L'[étude 015](../etudes/015_univers_polygon.md) distingue une liste de titres radiés de leurs prix effectivement accessibles.
L'[étude 020](../etudes/020_meilleures_idees_13f.md) utilise la date de dépôt des déclarations de gestionnaires, mais reste limitée par les prix manquants.
...
Le [guide des données datées](../data/point_in_time.md) décrit les champs employés par le code.
Le [chapitre suivant](03_calendrier.md) organise les périodes du test.
