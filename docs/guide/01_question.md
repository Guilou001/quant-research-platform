...
L'[étude 001](../etudes/001_time_series_momentum.md) examine le suivi de tendance après publication.
L'[étude 008](../etudes/008_carry.md) s'intéresse au portage de devises.
L'[étude 021](../etudes/021_portefeuille_de_primes.md) combine plusieurs sources de rendement et étudie leurs risques communs.
...
La [fiche de Moskowitz, Ooi et Pedersen](../literature/moskowitz_ooi_pedersen_2012.md) illustre ce travail préparatoire.
Le [chapitre suivant](02_donnees.md) examine ce que les données permettent réellement de tester.
