...
L'[étude 003](../etudes/003_value_and_momentum.md) observe une corrélation négative entre valeur et momentum.
...
L'[étude 009](../etudes/009_multi_strategy.md) compare plusieurs règles d'allocation sur des séries brutes.
L'[étude 012](../etudes/012_multi_strategy_net.md) reprend l'exercice après les coûts propres aux stratégies.
...
L'[étude 021](../etudes/021_portefeuille_de_primes.md) demande au mélange de dépasser sa meilleure composante selon un critère fixé.
...
Les références [Markowitz](../literature/markowitz_1952.md), [DeMiguel et coauteurs](../literature/demiguel_garlappi_uppal_2009.md) et [Ledoit et Wolf](../literature/ledoit_wolf_2004.md) expliquent les choix de risque et d'estimation.
Le [dernier chapitre](08_conclusion.md) aide à formuler ce que les preuves autorisent.
