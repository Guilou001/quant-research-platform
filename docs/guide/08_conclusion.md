...
Dans l'[étude 021](../etudes/021_portefeuille_de_primes.md), le contrôle nommé « réplication » compare en réalité le portefeuille à une composante.
...
Les [notes de relecture](../research_journal/pedagogie-2026-09-13.md) expliquent les corrections d'interprétation.
Le [catalogue des études](../etudes/index.md) permet de poursuivre selon la question qui vous intéresse.
