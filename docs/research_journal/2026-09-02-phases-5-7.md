...
| Meilleure stratégie seule, brut | 0,693 |
| Parité de risque, référence déclarée, net | **0,652** |
| Parité hiérarchique, net | **0,900** |
| Équipondération, net | 0,489 |
| Référence sur le holdout 2020-2026 | 0,239, t de 0,585 |

Comment lire ce tableau, en trois constats. La diversification travaille :
quatre allocations sur six dépassent la meilleure stratégie seule avec une
volatilité trois fois plus basse. La référence déclarée n'en fait pas partie,
à 0,652 contre 0,693. Et l'allocation qui domine tout, la parité hiérarchique,
a été vue gagner parmi six essais, ce qui interdit de la retenir.

L'apport marginal dit qui compte : l'arbitrage statistique ajoute 0,219 de
...
que la règle 6 interdit, et le Sharpe dégonflé à vingt essais, 0,474, chiffre
...
quatre allocations sur six au-dessus de la meilleure jambe ? Les coûts propres
