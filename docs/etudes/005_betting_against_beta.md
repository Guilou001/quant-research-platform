...
La [fiche de littérature](../literature/frazzini_pedersen_2014_bab.md) distingue cette explication des critiques portant sur la construction du facteur.
...
La [discussion sur l'estimation du risque](../literature/ledoit_wolf_2004.md) explique pourquoi stabiliser une estimation exige une comparaison adaptée.
