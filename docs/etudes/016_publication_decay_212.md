...
La [fiche de littérature](../literature/mclean_pontiff_2016.md) conserve le statut de lecture des sources.
...
Le [chapitre sur le hasard](../guide/04_hasard.md) explique comment la sélection initiale peut rendre une découverte trop favorable.
