...
La [fiche de littérature](../literature/cohen_polk_silli_2010.md) déclare cette limite.
...
Le [chapitre sur les données](../guide/02_donnees.md) distingue ces problèmes.
