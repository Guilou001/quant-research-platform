...
La comparaison reprend les références de l'[étude 009](009_multi_strategy.md).
...
Le [chapitre sur la diversification](../guide/07_portefeuille.md) explique pourquoi réduire le risque et améliorer le rendement moyen sont deux objectifs distincts.
