...
La [fiche de littérature](../literature/mclean_pontiff_2016.md) indique les résultats obtenus depuis le résumé et les limites d'accès au texte complet.
...
L'[étude 016](016_publication_decay_212.md) élargit l'analyse à des portefeuilles d'actions américains et distingue plus précisément les mesures.
