...
La [loi fondamentale](../literature/grinold_1989.md) relie la qualité des prévisions à la diversité effective des paris, sous des hypothèses.
[DeMiguel et coauteurs](../literature/demiguel_garlappi_uppal_2009.md) motivent la comparaison avec une allocation à parts égales.
L'[étude 003](003_value_and_momentum.md) fournit un exemple de diversification observée.
...
L'[étude 012](012_multi_strategy_net.md) reprend la comparaison avec les coûts propres aux composantes.
