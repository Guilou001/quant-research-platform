...
|---|---|---|---|---|
| 1 | Un univers d'actions sans biais de survie | tout travail transversal sur actions ; l'étude 013 est aujourd'hui non concluante par construction | un fournisseur payant, la clé Polygon existe ; spécification 001 écrite | mesuré, le biais fabrique 7,1 %/an de faux renversement |
| 2 | La largeur : 210 signaux plutôt que 5 | la loi fondamentale, de 5,4 paris à des dizaines ; l'étude 014 refaite sur 200 prédicteurs | le jeu de Chen et Zimmermann, libre, déjà cité ; un mois | rapporté, 98 % des 161 signaux significatifs se répliquent chez eux |
| 3 | L'exécution : viser devant la cible | réduire la rotation qui tue l'arbitrage statistique et coûte 71 pb/an au momentum | Gârleanu et Pedersen (2013), deux semaines | rapporté, gain net « supérieur aux références naïves » dans leur article |
| 4 | L'horizon : nuit contre journée | savoir quand chacune des huit stratégies gagne ; les barres à la minute existent déjà dans le portefeuille | Lou, Polk et Skouras (2019), une semaine | rapporté, le momentum gagne la nuit, la valeur le jour |
| 5 | Les données publiques point-in-time que personne ne lit | 13F, formulaires 4 d'initiés, dérive post-annonce sur XBRL, l'atout du laboratoire | la SEC répond déjà ; un mois par source | rapporté, alpha des « meilleures idées » de Cohen, Polk et Silli (2010) ; dérive en déclin |
| 6 | Un marché moins efficace : les cryptomonnaies | les mêmes facteurs, marché, taille, momentum, sur un marché jeune et ouvert | données d'échange libres ; le même parcours de vingt étapes | rapporté, Liu, Tsyvinski et Wu (2022) ; momentum hebdomadaire de 3 % dans leur échantillon |
