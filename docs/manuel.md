...
L'[étude 001](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/001_time_series_momentum.md) examine le suivi de tendance après publication.
L'[étude 008](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/008_carry.md) s'intéresse au portage de devises.
L'[étude 021](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/021_portefeuille_de_primes.md) combine plusieurs sources de rendement et étudie leurs risques communs.
...
La [fiche de Moskowitz, Ooi et Pedersen](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/moskowitz_ooi_pedersen_2012.md) illustre ce travail préparatoire.
Le [chapitre suivant](https://github.com/Guilou001/quant-research-platform/blob/main/docs/guide/02_donnees.md) examine ce que les données permettent réellement de tester.
...
![Capital final avec et sans les deux entreprises disparues dans un exemple fictif](guide/figures/survie_exemple.png)
...
L'[étude 013](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/013_cross_sectional_ml_long.md) montre pourquoi un historique plus long ne répare pas une sélection incomplète.
L'[étude 015](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/015_univers_polygon.md) distingue une liste de titres radiés de leurs prix effectivement accessibles.
L'[étude 020](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/020_meilleures_idees_13f.md) utilise la date de dépôt des déclarations de gestionnaires, mais reste limitée par les prix manquants.
...
Le [guide des données datées](https://github.com/Guilou001/quant-research-platform/blob/main/docs/data/point_in_time.md) décrit les champs employés par le code.
Le [chapitre suivant](https://github.com/Guilou001/quant-research-platform/blob/main/docs/guide/03_calendrier.md) organise les périodes du test.
...
![Trois périodes séparées dans un calendrier fictif](guide/figures/calendrier.png)
...
L'[étude 017](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/017_viser_devant_la_cible.md) choisit une vitesse de rééquilibrage avant la période finale.
...
Les [découpages de validation](https://github.com/Guilou001/quant-research-platform/blob/main/docs/validation/index.md) décrivent les procédures disponibles.
L'[étude 011](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/011_cross_sectional_ml.md) montre leur emploi pour prévoir les rendements des actions.

Avant de comparer deux résultats, vérifiez qu'ils portent sur les mêmes mois.
Le [chapitre suivant](https://github.com/Guilou001/quant-research-platform/blob/main/docs/guide/04_hasard.md) explique pourquoi leur différence demande encore une mesure d'incertitude.
...
![Le gagnant de la sélection confronté à une seconde période indépendante](guide/figures/selection_hasard.png)
...
![Distribution de moyennes obtenues par blocs sur douze mois fictifs](guide/figures/bootstrap.png)
...
Les fiches [DSR](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/bailey_lopez_de_prado_2014_dsr.md), [PBO](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/bailey_et_al_2016_pbo.md) et [tests multiples](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/harvey_liu_zhu_2016.md) détaillent leurs hypothèses.
L'[étude 016](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/016_publication_decay_212.md) montre pourquoi une différence historique et une cause établie restent deux conclusions distinctes.
...
![Prévisions proches des niveaux observés, mais préférences inversées](guide/figures/prevision_classement.png)

L'[étude 011](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/011_cross_sectional_ml.md) déroule le calcul à la main.
...
La [fiche de l'article](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/gu_kelly_xiu_2020.md) sépare la méthode originale et notre adaptation.

L'[étude 013](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/013_cross_sectional_ml_long.md) étend la période étudiée.
...
L'[étude 018](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/018_nuit_contre_journee.md) explique pourquoi on ne peut pas appliquer ce calcul sans vérifier les positions réellement négociées.
L'[étude 007](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/007_statistical_arbitrage.md) mesure le seuil de coût qui annule son propre rendement brut.
...
L'[étude 010](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/010_capacity.md) examine cette question sur deux stratégies dont les positions et les volumes sont disponibles.
...
Le [moteur analytique](https://github.com/Guilou001/quant-research-platform/blob/main/docs/analytics/index.md) décrit les conventions, et les annexes donnent les coefficients propres aux études.

L'[étude 017](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/017_viser_devant_la_cible.md) pose ensuite une question pratique.
...
L'[étude 003](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/003_value_and_momentum.md) observe une corrélation négative entre valeur et momentum.
...
L'[étude 009](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/009_multi_strategy.md) compare plusieurs règles d'allocation sur des séries brutes.
L'[étude 012](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/012_multi_strategy_net.md) reprend l'exercice après les coûts propres aux stratégies.
...
L'[étude 021](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/021_portefeuille_de_primes.md) demande au mélange de dépasser sa meilleure composante selon un critère fixé.
...
Les références [Markowitz](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/markowitz_1952.md), [DeMiguel et coauteurs](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/demiguel_garlappi_uppal_2009.md) et [Ledoit et Wolf](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/ledoit_wolf_2004.md) expliquent les choix de risque et d'estimation.
Le [dernier chapitre](https://github.com/Guilou001/quant-research-platform/blob/main/docs/guide/08_conclusion.md) aide à formuler ce que les preuves autorisent.
...
Dans l'[étude 021](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/021_portefeuille_de_primes.md), le contrôle nommé « réplication » compare en réalité le portefeuille à une composante.
...
Le [registre des valeurs](https://github.com/Guilou001/quant-research-platform/blob/main/documentation/publication_values.json) relie les chiffres du cours aux fichiers de résultats.
...
Les [notes de relecture](https://github.com/Guilou001/quant-research-platform/blob/main/docs/research_journal/pedagogie-2026-09-13.md) expliquent les corrections d'interprétation.
Le [catalogue des études](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/index.md) permet de poursuivre selon la question qui vous intéresse.
...
La [fiche de littérature](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/moskowitz_ooi_pedersen_2012.md) présente aussi les explications concurrentes.
...
L'[étude 017](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/017_viser_devant_la_cible.md) demande ensuite si échanger moins souvent améliore ce résultat.
La [comparaison avec LEAN](https://github.com/Guilou001/quant-research-platform/blob/main/lean/README.md) examine l'exécution dans un second moteur.

### Vérifier le résultat

Les [mesures enregistrées](https://github.com/Guilou001/quant-research-platform/blob/main/studies/001_time_series_momentum/results/metrics.json) donnent les nombres et leurs fenêtres.
L'[annexe technique](https://github.com/Guilou001/quant-research-platform/blob/main/studies/001_time_series_momentum/ANNEXE_TECHNIQUE.md) conserve les tableaux, les hypothèses, les limites et les commandes de calcul.
Le [script de l'étude](https://github.com/Guilou001/quant-research-platform/blob/main/studies/001_time_series_momentum/run.py) relie ces choix aux fonctions du laboratoire.
...
La [fiche de l'article](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/jegadeesh_titman_1993.md) précise les périodes de formation, de détention et le délai entre les deux.
...
Cet exemple réel justifie la prudence du [chapitre sur les données](https://github.com/Guilou001/quant-research-platform/blob/main/docs/guide/02_donnees.md).
...
La [fiche de littérature](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/asness_moskowitz_pedersen_2013.md) précise les définitions et les comparaisons.
...
|---|---:|
| Corrélation valeur et momentum | -0,577 |
| Sharpe du momentum seul | 0,593 |
| Sharpe du mélange à parts égales | 1,096 |
...
L'[étude 012](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/012_multi_strategy_net.md) poursuit la question après les coûts.

### Vérifier le résultat

Les [mesures enregistrées](https://github.com/Guilou001/quant-research-platform/blob/main/studies/003_value_and_momentum/results/metrics.json) donnent les nombres et leurs fenêtres.
L'[annexe technique](https://github.com/Guilou001/quant-research-platform/blob/main/studies/003_value_and_momentum/ANNEXE_TECHNIQUE.md) conserve les tableaux, les hypothèses, les limites et les commandes de calcul.
Le [script de l'étude](https://github.com/Guilou001/quant-research-platform/blob/main/studies/003_value_and_momentum/run.py) relie ces choix aux fonctions du laboratoire.
...
La [fiche Quality Minus Junk](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/asness_frazzini_pedersen_2019_qmj.md) présente les composantes du score et les versions de l'article.
...
Le [registre des données](https://github.com/Guilou001/quant-research-platform/blob/main/docs/data/index.md) aide à retrouver leurs limites.
...
La [fiche de littérature](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/frazzini_pedersen_2014_bab.md) distingue cette explication des critiques portant sur la construction du facteur.
...
La [discussion sur l'estimation du risque](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/ledoit_wolf_2004.md) explique pourquoi stabiliser une estimation exige une comparaison adaptée.

### Vérifier le résultat

Les [mesures enregistrées](https://github.com/Guilou001/quant-research-platform/blob/main/studies/005_betting_against_beta/results/metrics.json) donnent les nombres et leurs fenêtres.
L'[annexe technique](https://github.com/Guilou001/quant-research-platform/blob/main/studies/005_betting_against_beta/ANNEXE_TECHNIQUE.md) conserve les tableaux, les hypothèses, les limites et les commandes de calcul.
Le [script de l'étude](https://github.com/Guilou001/quant-research-platform/blob/main/studies/005_betting_against_beta/run.py) relie ces choix aux fonctions du laboratoire.
...
La [fiche de littérature](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/moreira_muir_2017.md) détaille la version de travail consultée.
Le laboratoire retrouve un alpha de 4,743 % par an pour le marché sur août 1926 à avril 2015, avant frais.
...
Avec une mise à l'échelle estimée sur le passé, l'alpha mesuré sur août 1936 à juin 2026 vaut 2,438 % par an, avant frais.
...
Le [chapitre du calendrier](https://github.com/Guilou001/quant-research-platform/blob/main/docs/guide/03_calendrier.md) donne le vocabulaire pour distinguer ces deux usages.

### Vérifier le résultat

Les [mesures enregistrées](https://github.com/Guilou001/quant-research-platform/blob/main/studies/006_volatility_managed/results/metrics.json) donnent les nombres et leurs fenêtres.
L'[annexe technique](https://github.com/Guilou001/quant-research-platform/blob/main/studies/006_volatility_managed/ANNEXE_TECHNIQUE.md) conserve les tableaux, les hypothèses, les limites et les commandes de calcul.
Le [script de l'étude](https://github.com/Guilou001/quant-research-platform/blob/main/studies/006_volatility_managed/run.py) relie ces choix aux fonctions du laboratoire.
...
La [fiche de l'article](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/avellaneda_lee_2010.md) explique les composantes principales et la règle de retour à la moyenne.
...
Le seuil de coût qui annule le rendement brut vaut 3,916 points de base par unité négociée sur l'historique de la reconstruction.
La période de comparaison avec l'article, de 1997 à 2007, donne un Sharpe brut de 1,461.
...
L'[étude 010](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/010_capacity.md) ajoute ensuite les contraintes de taille.

### Vérifier le résultat

Les [mesures enregistrées](https://github.com/Guilou001/quant-research-platform/blob/main/studies/007_statistical_arbitrage/results/metrics.json) donnent les nombres et leurs fenêtres.
L'[annexe technique](https://github.com/Guilou001/quant-research-platform/blob/main/studies/007_statistical_arbitrage/ANNEXE_TECHNIQUE.md) conserve les tableaux, les hypothèses, les limites et les commandes de calcul.
Le [script de l'étude](https://github.com/Guilou001/quant-research-platform/blob/main/studies/007_statistical_arbitrage/run.py) relie ces choix aux fonctions du laboratoire.
...
La [fiche de littérature](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/koijen_moskowitz_pedersen_vrugt_2018.md) explique pourquoi les autres classes ne sont pas reconstruites ici.

### Le résultat et sa sensibilité

Sur novembre 1983 à septembre 2012, la régression donne un coefficient de 1,084 et une statistique t de 2,159.
...
Les [mesures enregistrées](https://github.com/Guilou001/quant-research-platform/blob/main/studies/008_carry/results/metrics.json) donnent les nombres et leurs fenêtres.
L'[annexe technique](https://github.com/Guilou001/quant-research-platform/blob/main/studies/008_carry/ANNEXE_TECHNIQUE.md) conserve les tableaux, les hypothèses, les limites et les commandes de calcul.
Le [script de l'étude](https://github.com/Guilou001/quant-research-platform/blob/main/studies/008_carry/run.py) relie ces choix aux fonctions du laboratoire.
...
La [loi fondamentale](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/grinold_1989.md) relie la qualité des prévisions à la diversité effective des paris, sous des hypothèses.
[DeMiguel et coauteurs](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/demiguel_garlappi_uppal_2009.md) motivent la comparaison avec une allocation à parts égales.
L'[étude 003](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/003_value_and_momentum.md) fournit un exemple de diversification observée.

### Lire les fenêtres séparément

La référence en parité de risque présente un Sharpe de 1,031 avant la période finale et de 0,214 sur les 78 mois de janvier 2020 à juin 2026.
...
L'[étude 012](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/012_multi_strategy_net.md) reprend la comparaison avec les coûts propres aux composantes.
Elle permet de voir ce que la lecture des seules séries brutes masquait.

### Vérifier le résultat

Les [mesures enregistrées](https://github.com/Guilou001/quant-research-platform/blob/main/studies/009_multi_strategy/results/metrics.json) donnent les nombres et leurs fenêtres.
L'[annexe technique](https://github.com/Guilou001/quant-research-platform/blob/main/studies/009_multi_strategy/ANNEXE_TECHNIQUE.md) conserve les tableaux, les hypothèses, les limites et les commandes de calcul.
Le [script de l'étude](https://github.com/Guilou001/quant-research-platform/blob/main/studies/009_multi_strategy/run.py) relie ces choix aux fonctions du laboratoire.
...
Le [contexte d'exécution](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/almgren_chriss_2001.md) explique pourquoi taille, calendrier et impact sont liés.
...
![Les trois actions prévues et observées](guide/figures/prevision_classement.png)
...
La [fiche de littérature](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/gu_kelly_xiu_2020.md) détaille les spécifications et les versions consultées.
...
Les nombres proviennent des [erreurs et classements](https://github.com/Guilou001/quant-research-platform/blob/main/studies/011_cross_sectional_ml/results/tables/evaluation.csv)
et des [portefeuilles](https://github.com/Guilou001/quant-research-platform/blob/main/studies/011_cross_sectional_ml/results/tables/portfolios.csv).
...
L'[annexe technique](https://github.com/Guilou001/quant-research-platform/blob/main/studies/011_cross_sectional_ml/ANNEXE_TECHNIQUE.md) conserve les six modèles et leurs fenêtres.
L'[étude 013](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/013_cross_sectional_ml_long.md) prolonge l'historique sans résoudre la sélection des entreprises.
...
La comparaison reprend les références de l'[étude 009](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/009_multi_strategy.md).
...
Le [chapitre sur la diversification](https://github.com/Guilou001/quant-research-platform/blob/main/docs/guide/07_portefeuille.md) explique pourquoi réduire le risque et améliorer le rendement moyen sont deux objectifs distincts.

### Vérifier le résultat

Les [mesures enregistrées](https://github.com/Guilou001/quant-research-platform/blob/main/studies/012_multi_strategy_net/results/metrics.json) donnent les nombres et leurs fenêtres.
L'[annexe technique](https://github.com/Guilou001/quant-research-platform/blob/main/studies/012_multi_strategy_net/ANNEXE_TECHNIQUE.md) conserve les tableaux, les hypothèses, les limites et les commandes de calcul.
Le [script de l'étude](https://github.com/Guilou001/quant-research-platform/blob/main/studies/012_multi_strategy_net/run.py) relie ces choix aux fonctions du laboratoire.
...
L'[étude 011](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/011_cross_sectional_ml.md) dispose d'un historique court et de 27 caractéristiques.
...
La [fiche Gu, Kelly et Xiu](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/gu_kelly_xiu_2020.md) explique le protocole de référence et ses différences avec nos données.
...
Le [chapitre sur les dates](https://github.com/Guilou001/quant-research-platform/blob/main/docs/guide/02_donnees.md) explique pourquoi dater les informations et reconstruire l'univers sont deux contrôles différents.
...
La [fiche de littérature](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/mclean_pontiff_2016.md) indique les résultats obtenus depuis le résumé et les limites d'accès au texte complet.
...
La baisse moyenne calculée par les rapports vaut 72,7 %, avant les coûts propres à une mise en œuvre.
...
L'[étude 016](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/016_publication_decay_212.md) élargit l'analyse à des portefeuilles d'actions américains et distingue plus précisément les mesures.

### Vérifier le résultat

Les [mesures enregistrées](https://github.com/Guilou001/quant-research-platform/blob/main/studies/014_publication_decay/results/metrics.json) donnent les nombres et leurs fenêtres.
L'[annexe technique](https://github.com/Guilou001/quant-research-platform/blob/main/studies/014_publication_decay/ANNEXE_TECHNIQUE.md) conserve les tableaux, les hypothèses, les limites et les commandes de calcul.
Le [script de l'étude](https://github.com/Guilou001/quant-research-platform/blob/main/studies/014_publication_decay/run.py) relie ces choix aux fonctions du laboratoire.
...
L'extraction conserve 6 425 actions ordinaires radiées et datées depuis 2004.
...
L'[étude 013](https://github.com/Guilou001/quant-research-platform/blob/main/docs/etudes/013_cross_sectional_ml_long.md) reste limitée par un panel de survivants.
...
Le [cahier de l'univers historique](https://github.com/Guilou001/quant-research-platform/blob/main/docs/specs/001-univers-sans-biais-de-survie.md) définit ce que la source devait fournir.
...
Les [mesures enregistrées](https://github.com/Guilou001/quant-research-platform/blob/main/studies/015_univers_polygon/results/metrics.json) donnent les nombres et leurs fenêtres.
L'[annexe technique](https://github.com/Guilou001/quant-research-platform/blob/main/studies/015_univers_polygon/ANNEXE_TECHNIQUE.md) conserve les tableaux, les hypothèses, les limites et les commandes de calcul.
Le [script de l'étude](https://github.com/Guilou001/quant-research-platform/blob/main/studies/015_univers_polygon/run.py) relie ces choix aux fonctions du laboratoire.


## 016 Que reste-t-il d'une stratégie après sa publication ?

Le rendement diminue après publication pour 82,7 % des 208 portefeuilles comparables de cette étude.
...
Le fichier téléchargé contient 212 portefeuilles. Le minimum d'observations laisse 208 comparaisons après publication.
...
La [fiche de littérature](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/mclean_pontiff_2016.md) conserve le statut de lecture des sources.

### Lire ensemble la moyenne, la médiane et la régression

| Mesure | Résultat après publication |
|---|---:|
| Rendement antérieur conservé, médiane des rapports | 41,9 % |
| Rendement antérieur conservé, moyenne des rapports | 53,0 % |
| Portefeuilles dont le rendement diminue | 82,7 % |
| Baisse estimée par la régression retenue | 36,4 % |
| Statistique t de cette baisse dans la régression | -1,20 |
...
Sources numériques dans les [fenêtres individuelles](https://github.com/Guilou001/quant-research-platform/blob/main/studies/016_publication_decay_212/results/tables/windows.csv)
et les [résultats enregistrés](https://github.com/Guilou001/quant-research-platform/blob/main/studies/016_publication_decay_212/results/metrics.json).

![Les rapports avant et après publication](guide/figures/publication_distribution.png)
...
L'[annexe technique](https://github.com/Guilou001/quant-research-platform/blob/main/studies/016_publication_decay_212/ANNEXE_TECHNIQUE.md) contient les autres regroupements et les conventions.
Le [chapitre sur le hasard](https://github.com/Guilou001/quant-research-platform/blob/main/docs/guide/04_hasard.md) explique comment la sélection initiale peut rendre une découverte trop favorable.
...
La [fiche de littérature](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/garleanu_pedersen_2013.md) explique la différence.
...
Cette distinction est le sujet du [chapitre sur le calendrier](https://github.com/Guilou001/quant-research-platform/blob/main/docs/guide/03_calendrier.md).
...
La [fiche de l'article](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/lou_polk_skouras_2019.md) présente les stratégies et les limites de la transposition.
...
Ces nombres viennent de la section `strategy` des [résultats enregistrés](https://github.com/Guilou001/quant-research-platform/blob/main/studies/018_nuit_contre_journee/results/metrics.json).
...
![Décomposer le résultat de nuit et de séance](guide/figures/nuit_journee.png)
...
L'[annexe technique](https://github.com/Guilou001/quant-research-platform/blob/main/studies/018_nuit_contre_journee/ANNEXE_TECHNIQUE.md) conserve les cinq fonds et les contrôles d'identité.
La [comparaison avec LEAN](https://github.com/Guilou001/quant-research-platform/blob/main/lean/README.md) examine séparément ce que change un autre calendrier d'exécution.
...
La [spécification](https://github.com/Guilou001/quant-research-platform/blob/main/docs/specs/005-cryptomonnaies-coin-metrics.md) décrit les données communautaires Coin Metrics.
...
Les [mesures enregistrées](https://github.com/Guilou001/quant-research-platform/blob/main/studies/019_facteurs_crypto/results/metrics.json) donnent les nombres et leurs fenêtres.
L'[annexe technique](https://github.com/Guilou001/quant-research-platform/blob/main/studies/019_facteurs_crypto/ANNEXE_TECHNIQUE.md) conserve les tableaux, les hypothèses, les limites et les commandes de calcul.
Le [script de l'étude](https://github.com/Guilou001/quant-research-platform/blob/main/studies/019_facteurs_crypto/run.py) relie ces choix aux fonctions du laboratoire.
...
La [fiche de littérature](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/cohen_polk_silli_2010.md) déclare cette limite.
...
Sur 157 mois, de 2013 à août 2026, la série des écarts mensuels au marché produit un rendement composé annualisé de 0,27 % avant frais.
Il devient -0,05 % après dix points de base par unité négociée selon la convention de l'étude.
...
28,9 % des idées formées n'ont pas de prix dans la source utilisée.
...
Le [chapitre sur les données](https://github.com/Guilou001/quant-research-platform/blob/main/docs/guide/02_donnees.md) distingue ces problèmes.

### Vérifier le résultat

Les [mesures enregistrées](https://github.com/Guilou001/quant-research-platform/blob/main/studies/020_meilleures_idees_13f/results/metrics.json) donnent les nombres et leurs fenêtres.
L'[annexe technique](https://github.com/Guilou001/quant-research-platform/blob/main/studies/020_meilleures_idees_13f/ANNEXE_TECHNIQUE.md) conserve les tableaux, les hypothèses, les limites et les commandes de calcul.
Le [script de l'étude](https://github.com/Guilou001/quant-research-platform/blob/main/studies/020_meilleures_idees_13f/run.py) relie ces choix aux fonctions du laboratoire.


## 021 Pourquoi refuser un portefeuille qui gagne de l'argent ?

Le portefeuille étudié obtient un Sharpe net de 0,629, mais ne remplit pas tous les critères fixés pour le retenir.
Son meilleur composant seul obtient 0,696 sur la même période.
...
Les références sont [Hurst, Ooi et Pedersen](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/hurst_ooi_pedersen_2017.md),
[Asness, Moskowitz et Pedersen](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/asness_moskowitz_pedersen_2013.md)
et [Moreira et Muir](https://github.com/Guilou001/quant-research-platform/blob/main/docs/literature/moreira_muir_2017.md).
La [spécification initiale](https://github.com/Guilou001/quant-research-platform/blob/main/docs/specs/007-indices-cboe-et-empilement.md) décrit les choix écrits avant les calculs de cette étude.
...
Le test couvre 187 mois, de décembre 2010 à juin 2026.
Les 78 derniers mois constituent la période finale réservée dans le protocole local.
...
|---|---:|---|
| Sharpe du portefeuille net | 0,629 | Rendement excédentaire rapporté à sa dispersion |
| Sharpe du meilleur composant seul | 0,696 | Le portefeuille ne le dépasse pas sur ce critère |
| Sharpe dans la période finale | 0,884 | Résultat positif dans la fenêtre réservée |
| Statistique t dans la période finale | 2,30 | Sous le seuil de 3 fixé dans le protocole |
| Pire repli depuis un sommet | -16,0 % | Perte historique maximale de la courbe retenue |
...
Source dans les [résultats de référence](https://github.com/Guilou001/quant-research-platform/blob/main/studies/021_portefeuille_de_primes/results/metrics.json).

![Les critères de décision du portefeuille](guide/figures/verdict_portefeuille.png)
...
Le [fichier de verdict](https://github.com/Guilou001/quant-research-platform/blob/main/studies/021_portefeuille_de_primes/results/tables/verdict_reasons.csv) appelle « réplication » la comparaison avec le meilleur composant.
...
L'[annexe technique](https://github.com/Guilou001/quant-research-platform/blob/main/studies/021_portefeuille_de_primes/ANNEXE_TECHNIQUE.md) conserve les variantes, les retraits de composantes et les coûts.
Le [chapitre sur le verdict](https://github.com/Guilou001/quant-research-platform/blob/main/docs/guide/08_conclusion.md) donne une grille pour lire les autres études avec la même distinction.
