...
la faible volatilité est le seul fonds dont la part de jour dépasse celle de nuit, ce que l'article ne
...
La décomposition porte sur le brut.
Détenir seulement la nuit demanderait une entrée et une sortie fréquentes.
Un aller-retour de quatre points de base répété 250 fois coûte 10 % d'un capital initial constamment engagé, dans un exemple à montant fixe.
Il faut calculer les montants effectivement négociés avant de conclure que les frais annulent le gain de cette stratégie.
...
| Résidu du total excédentaire face aux deux composantes, -0,75 % par an | mesuré et publié |
