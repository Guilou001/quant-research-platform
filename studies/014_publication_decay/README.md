...
La [fiche de littérature](../../docs/literature/mclean_pontiff_2016.md) indique les résultats obtenus depuis le résumé et les limites d'accès au texte complet.
...
L'[étude 016](../../docs/etudes/016_publication_decay_212.md) élargit l'analyse à des portefeuilles d'actions américains et distingue plus précisément les mesures.
