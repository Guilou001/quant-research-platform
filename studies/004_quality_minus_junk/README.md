...
La [fiche Quality Minus Junk](../../docs/literature/asness_frazzini_pedersen_2019_qmj.md) présente les composantes du score et les versions de l'article.
...
Le [registre des données](../../docs/data/index.md) aide à retrouver leurs limites.
