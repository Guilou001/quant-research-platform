...
![Ce que l'oubli de deux entreprises change](../../docs/guide/figures/survie_exemple.png)
...
L'[étude 011](../../docs/etudes/011_cross_sectional_ml.md) dispose d'un historique court et de 27 caractéristiques.
...
La [fiche Gu, Kelly et Xiu](../../docs/literature/gu_kelly_xiu_2020.md) explique le protocole de référence et ses différences avec nos données.
...
Les [erreurs de prévision](results/tables/evaluation.csv)
et les [portefeuilles enregistrés](results/tables/portfolios.csv) sont les sources du tableau.
...
Les résultats détaillés et les écarts de définition restent dans l'[annexe technique](ANNEXE_TECHNIQUE.md).
Le [chapitre sur les dates](../../docs/guide/02_donnees.md) explique pourquoi dater les informations et reconstruire l'univers sont deux contrôles différents.
