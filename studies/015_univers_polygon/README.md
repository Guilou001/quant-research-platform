...
L'[étude 013](../../docs/etudes/013_cross_sectional_ml_long.md) reste limitée par un panel de survivants.
...
Le [cahier de l'univers historique](../../docs/specs/001-univers-sans-biais-de-survie.md) définit ce que la source devait fournir.
