...
La [fiche de l'article](../../docs/literature/jegadeesh_titman_1993.md) précise les périodes de formation, de détention et le délai entre les deux.
...
Cet exemple réel justifie la prudence du [chapitre sur les données](../../docs/guide/02_donnees.md).
