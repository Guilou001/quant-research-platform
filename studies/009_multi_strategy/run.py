"""Étude 009 : huit sources d'alpha, un seul portefeuille, et la question qui compte.
...
de ``quantlab`` et écrit ses résultats dans ``results/``. Il est déterministe.
    ...
    uv run python studies/009_multi_strategy/run.py
"""
