...
La [fiche de littérature](../../docs/literature/mclean_pontiff_2016.md) conserve le statut de lecture des sources.
...
Sources numériques dans les [fenêtres individuelles](results/tables/windows.csv)
et les [résultats enregistrés](results/metrics.json).

![Les rapports avant et après publication](../../docs/guide/figures/publication_distribution.png)
...
L'[annexe technique](ANNEXE_TECHNIQUE.md) contient les autres regroupements et les conventions.
Le [chapitre sur le hasard](../../docs/guide/04_hasard.md) explique comment la sélection initiale peut rendre une découverte trop favorable.
