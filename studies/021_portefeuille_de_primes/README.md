...
Les références sont [Hurst, Ooi et Pedersen](../../docs/literature/hurst_ooi_pedersen_2017.md),
[Asness, Moskowitz et Pedersen](../../docs/literature/asness_moskowitz_pedersen_2013.md)
et [Moreira et Muir](../../docs/literature/moreira_muir_2017.md).
La [spécification initiale](../../docs/specs/007-indices-cboe-et-empilement.md) décrit les choix écrits avant les calculs de cette étude.
...
Source dans les [résultats de référence](results/metrics.json).

![Les critères de décision du portefeuille](../../docs/guide/figures/verdict_portefeuille.png)
...
Le [fichier de verdict](results/tables/verdict_reasons.csv) appelle « réplication » la comparaison avec le meilleur composant.
...
L'[annexe technique](ANNEXE_TECHNIQUE.md) conserve les variantes, les retraits de composantes et les coûts.
Le [chapitre sur le verdict](../../docs/guide/08_conclusion.md) donne une grille pour lire les autres études avec la même distinction.
