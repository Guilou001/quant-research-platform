...
La [fiche de littérature](../../docs/literature/cohen_polk_silli_2010.md) déclare cette limite.
...
Le [chapitre sur les données](../../docs/guide/02_donnees.md) distingue ces problèmes.
